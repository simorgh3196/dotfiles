...
complete -c deno -n "__fish_seen_subcommand_from bench" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically'
...
complete -c deno -n "__fish_seen_subcommand_from bundle" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically'
...
complete -c deno -n "__fish_seen_subcommand_from fmt" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically'
...
complete -c deno -n "__fish_seen_subcommand_from lint" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically'
...
complete -c deno -n "__fish_seen_subcommand_from run" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically' -r -F
...
complete -c deno -n "__fish_seen_subcommand_from test" -l watch -d 'UNSTABLE: Watch for file changes and restart automatically'
